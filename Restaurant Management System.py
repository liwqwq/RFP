...
def showProduct():
    ...
    for commodity in commoditylist:
        print("-" + commodity["id"] + "----" + commodity["name"] + "-----" + str(commodity["price"]) + "-----" + str(
            commodity["discount"]))
    print("----------------------------")
        ...
        for price in newlist:
            for product in commoditylist:
                if price == product["price"]:
                    print("-" + product["id"] + "----" + product["name"] + "-----" + str(product["price"]) + "-----" + str(
                        product["discount"]))
    else:
...
while True:
    ...
    if result == "Success":
        while True:
            ...
            print("4. Set Product Discount")
            print("5. Modify Product Information")
            print("6. Sort Products by Price")
            print("7. Create New Order")
            print("8. View Order List")
            ...
            if choice == 1:
                ...
                print("This function does not exist, please re-enter.")
                continue